...
// Define una estructura de datos Trie para facilitar las búsquedas eficientes por prefijos.
...
std::vector<std::shared_ptr<Movie>> Trie::search(const std::string& word) {
    ...
    // Calcular y ordenar las películas según el relevance_score
    ...
    // Ordenar el resultado por relevance_score en orden descendente
